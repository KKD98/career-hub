...
const FeaturedJobs = () => {
    ...
    return (
        ...
        <p className='text-center text-gray-500 my-5'>Explore thousands of job opportunities with all the information you need. Its your future.</p>
           ...
           {
            featuredjobs === true ? allFeaturedJobs.map(featuredJob => <SingleFeaturedJob key={featuredJob.id} featuredJob={featuredJob}></SingleFeaturedJob>) : fourFeatures.map(featuredJob => <SingleFeaturedJob key={featuredJob.id} featuredJob={featuredJob}></SingleFeaturedJob>)
           }
