    ...
    return (
        <div className='flex flex-col gap-5 justify-center mx-auto w-[80%]'>
            {/* <div className='border-4 border-indigo-300 rounded p-4 w-full mx-3 md:mx-4'>
                ...
                <p className='text-indigo-400 font-semibold text-2xl'>Answer: </p>
            </div>
            <div className='border-4 border-indigo-300 rounded p-4 w-full mx-3 md:mx-4'>
                <h3 className='text-indigo-500 font-bold text-2xl'>Question: What is a custom hook?</h3>
                <p className='text-indigo-400 font-semibold text-2xl'>Answer: Custom Hook is a JavaScript function which we create by ourselves, when we want to share logic between other JavaScript functions. Custom React hooks are an essential tool that let you add special, unique functionality to your React applications.</p>
            </div>
            <div className='border-4 border-indigo-300 rounded p-4 w-full mx-3 md:mx-4'>
